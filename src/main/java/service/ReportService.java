    ...
    public void showPackageAvailabilityReport() {
        ...
        if (rows.isEmpty()) {
            ...
            for (PackageAvailabilityRow r : rows) {
                ...
                System.out.printf(ColorText.warning("  ║") + "  %-6d" + ColorText.warning("║") + "  %-18s" + ColorText.warning("║") + "  %-8.0f" + ColorText.warning("║") + "  %-8d" + ColorText.warning("║") + "  %-10d" + ColorText.warning("║") + "  %-8d" + ColorText.warning("║") + "  %-9d" + ColorText.warning("║") + "  %-9d" + ColorText.warning("║") + "  %-16s" + ColorText.warning("║") + "%n",
